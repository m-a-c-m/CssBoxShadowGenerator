...
```bash
git clone https://github.com/m-a-c-m/CssBoxShadowGenerator.git
cd CssBoxShadowGenerator
npm install
npm run dev
```
...
```env
NEXT_PUBLIC_SITE_URL=https://miguelacm.es/tools/css-box-shadow
NEXT_PUBLIC_EMBED_URL=https://miguelacm.es/embed/css-box-shadow
```
...
<iframe
  ...
  title="CSS Box Shadow Generator — miguelacm.es"
  loading="lazy"
></iframe>
```
